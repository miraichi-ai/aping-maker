...
const ja = {
    ...
    TOAST_optimizing: 'ファイル容量を最適化しています...',
    TOAST_validationFailed: 'エラー: LINEスタンプの条件を満たしていないため保存できません。',
    ERROR_sizeTooLarge: '限界まで圧縮しましたが容量オーバー（{max}KB以上）です。フレーム数やFPSを減らしてください。',
...
const en = {
    ...
    TOAST_optimizing: 'Optimizing file size...',
    TOAST_validationFailed: 'Error: Cannot save because LINE sticker requirements are not met.',
    ERROR_sizeTooLarge: 'Size exceeds the limit ({max}KB) even after maximum compression. Please reduce the frame count or FPS.',
